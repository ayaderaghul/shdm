...
;;  (print "mutate action")
  ...
  (define old-a (hash-ref n r))
  (define a (mutate-p old-a))
  (cond [(member r d)
...
(define (interact au1 au2 au3)
  ...
  (define a1 (randomise (hash-ref n1 0)))
  (define a2 (randomise (hash-ref n2 a1)))
  (define a3 (randomise (hash-ref n3 (convert a1 a2))))
